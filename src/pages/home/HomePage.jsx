...
export const HomePage = () => {
    ...
    return <div className="homepage-container ">
        ...
        <section className="home-facilities">
            ...
            <FacilityCard image={'https://img.freepik.com/free-vector/chemist-concept-illustration_114360-13532.jpg?t=st=1710310724~exp=1710314324~hmac=68502080931ce540ad05a5254714de1a1d2bb49f2d145fb79016aebb72a18af5&w=740'} background="#fff" title="Lab Tests" sub="Sample pickup at your home" onClick={()=> navigate('/Ai_Lab')}/>
